...
async function loadSteam(id: string): Promise<GamingAccount | null> {
...
async function loadTwitch(user: string): Promise<GamingAccount | null> {
...
async function loadRoblox(user: string): Promise<GamingAccount | null> {
