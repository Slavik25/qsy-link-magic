...
const EN: Record<string, string> = {
  ...
  "Misiones": "Missions",
  "Subir de rango": "Upgrade rank",
  "Plantillas": "Templates",
  "Explorar": "Explore",
  "Configuración": "Settings",
  "Administración": "Administration",
  "Editar perfil": "Edit profile",
  "Regalar Premium": "Gift Premium",
  "Regálalo a un amigo": "Give it to a friend",
  "Compartir mi perfil": "Share my profile",
  "Mi página": "My page",
  "Abrir menú": "Open menu",
  "Cerrar menú": "Close menu",
  "Todos los derechos reservados.": "All rights reserved.",
  "Link copiado": "Link copied",
  "No se pudo copiar el link": "Couldn't copy the link",
  "Guardar": "Save",
  ...
  "Descubrir plantillas": "Discover templates",
  "Ver la tienda": "Visit the shop",
...
const PT: Record<string, string> = {
  ...
  "Analíticas": "Análises",
  "Misiones": "Missões",
  "Subir de rango": "Subir de nível",
  "Plantillas": "Modelos",
  "Explorar": "Explorar",
  "Configuración": "Configurações",
  "Administración": "Administração",
  "Editar perfil": "Editar perfil",
  "Regalar Premium": "Presentear Premium",
  "Regálalo a un amigo": "Dê a um amigo",
  "Compartir mi perfil": "Compartilhar meu perfil",
  "Mi página": "Minha página",
  ...
  "No se pudo copiar el link": "Não foi possível copiar o link",
  "Guardar": "Salvar",
  ...
  "Descubrir plantillas": "Descobrir modelos",
  "Ver la tienda": "Ver a loja",
...
/** Panel de control (dashboard, editor de perfil y administración). */
const DASH_EN: Record<string, string> = {
  ...
  "Administración": "Administration",
  "Regalar Premium": "Gift Premium",
  "Regálalo a un amigo": "Gift it to a friend",
  "Compartir mi perfil": "Share my profile",
  "Cerrar sesión": "Sign out",
  "Mi página": "My page",
  "Abrir menú": "Open menu",
  ...
  "Volver a Perfiles": "Back to Profiles",
  "Todos los derechos reservados.": "All rights reserved.",
  // editor sections
  "Compartir": "Share",
  "Personalización": "Customization",
  ...
  "Control total de": "Full control of",
  "Usuarios, analíticas, moderación, seguridad y servicios en un solo lugar.":
    "Users, analytics, moderation, security and services in one place.",
  "Acceso restringido": "Access restricted",
  "Esta sección es exclusiva del equipo administrador de QSY.":
    "This section is exclusive to the QSY admin team.",
  "Verificando permisos…": "Checking permissions…",
  "Analíticas globales": "Global analytics",
  "Actividad global": "Global activity",
  "Sin actividad todavía.": "No activity yet.",
  "Visitas registradas en toda la red durante los últimos 7 días":
    "Visits recorded across the network over the last 7 days",
  "Todo lo que ocurre en QSY en tiempo real": "Everything happening on QSY in real time",
  "Denuncias abiertas": "Open reports",
  "Amenazas abiertas": "Open threats",
  "Sanciones activas": "Active sanctions",
  "Mensajes en muros": "Wall messages",
  "Insignias otorgadas": "Badges granted",
  "Likes otorgados": "Likes granted",
  "Visitas otorgadas": "Visits granted",
  "Artículos de la tienda": "Shop items",
  // stats & common
  "Visitas": "Visits",
  "Visitas totales": "Total visits",
  "Visitas únicas": "Unique visits",
  "Visitas al perfil": "Profile visits",
  "Likes": "Likes",
  ...
  "Buscar": "Search",
  "Ver más": "See more",
  "Rango temporal": "Time range",
  "Últimos 7 días de tu página pública.": "Last 7 days of your public page.",
  "7 días": "7 days",
  "90 días + países": "90 days + countries",
  "Nuevo perfil": "New profile",
  "Nuevo perfil independiente": "New independent profile",
  "Personaliza y actualiza tus páginas.": "Customize and update your pages.",
  "Límite alcanzado": "Limit reached",
  "Has alcanzado el límite de perfiles de tu plan.": "You reached your plan's profile limit.",
  "Mejorar plan": "Upgrade plan",
  "Mejorar ahora": "Upgrade now",
  "Tus QSY Coins": "Your QSY Coins",
  "Tu saldo": "Your balance",
  "Conseguir más en Misiones": "Get more in Missions",
  "Gana QSY Coins completando misiones difíciles.": "Earn QSY Coins by completing hard missions.",
  "Progreso": "Progress",
  "Progreso del perfil": "Profile progress",
  "Reclamar": "Claim",
  "Completada": "Completed",
  "Completar": "Complete",
  "Desbloqueado": "Unlocked",
  "Catálogo": "Catalog",
  "Historial de regalos": "Gift history",
  "Tu URL de perfil": "Your profile URL",
  "Elige tu dominio QSY, copia tu URL o descarga un código QR.":
    "Pick your QSY domain, copy your URL or download a QR code.",
  "Sin resultados.": "No results.",
  "Sin visitas aún": "No visits yet",
  "Nadie ha hecho clic todavía": "Nobody has clicked yet",
  "Links más clickeados": "Most clicked links",
  "Top países por visitas": "Top countries by visits",
  "Aún no hay datos de visitas": "No visit data yet",
  "Aún no hay datos de países": "No country data yet",
  "Aún no hay datos de dispositivos": "No device data yet",
  "Aún no hay navegadores": "No browsers yet",
  "Aún no hay referrers": "No referrers yet",
  ...
  "Público — Visible para todos": "Public — Visible to everyone",
  "No listado — Solo con el link": "Unlisted — Link only",
  "Privado — Solo tú": "Private — Only you",
...
const DASH_PT: Record<string, string> = {
  "Resumen": "Resumo",
  "Perfiles": "Perfis",
  "Conexiones": "Conexões",
  "Insignias": "Insígnias",
  ...
  "Misiones": "Missões",
  "Tienda": "Loja",
  "Subir de rango": "Subir de patente",
  "Plantillas": "Modelos",
  "Explorar": "Explorar",
  "Configuración": "Configurações",
  "Administración": "Administração",
  "Regalar Premium": "Presentear Premium",
  "Regálalo a un amigo": "Dê de presente a um amigo",
  "Compartir mi perfil": "Compartilhar meu perfil",
  "Cerrar sesión": "Sair",
  "Mi página": "Minha página",
  "Abrir menú": "Abrir menu",
  "Cerrar menú": "Fechar menu",
  "Editar perfil": "Editar perfil",
  "Volver al dashboard": "Voltar ao painel",
  "Volver a Perfiles": "Voltar aos Perfis",
  "Todos los derechos reservados.": "Todos os direitos reservados.",
  "Compartir": "Compartilhar",
  "Personalización": "Personalização",
  "Efectos": "Efeitos",
  ...
  "Control total de": "Controle total de",
  "Usuarios, analíticas, moderación, seguridad y servicios en un solo lugar.":
    "Usuários, análises, moderação, segurança e serviços em um só lugar.",
  "Acceso restringido": "Acesso restrito",
  "Esta sección es exclusiva del equipo administrador de QSY.":
    "Esta seção é exclusiva da equipe de administração da QSY.",
  "Verificando permisos…": "Verificando permissões…",
  "Analíticas globales": "Análises globais",
  "Actividad global": "Atividade global",
  "Sin actividad todavía.": "Ainda sem atividade.",
  "Visitas registradas en toda la red durante los últimos 7 días":
    "Visitas registradas em toda a rede nos últimos 7 dias",
  "Todo lo que ocurre en QSY en tiempo real": "Tudo o que acontece na QSY em tempo real",
  "Denuncias abiertas": "Denúncias abertas",
  "Amenazas abiertas": "Ameaças abertas",
  "Sanciones activas": "Sanções ativas",
  "Mensajes en muros": "Mensagens nos murais",
  "Insignias otorgadas": "Insígnias concedidas",
  "Likes otorgados": "Curtidas concedidas",
  "Visitas otorgadas": "Visitas concedidas",
  "Artículos de la tienda": "Itens da loja",
  "Visitas": "Visitas",
  "Visitas totales": "Visitas totais",
  "Visitas únicas": "Visitas únicas",
  "Visitas al perfil": "Visitas ao perfil",
  "Likes": "Curtidas",
  "Likes totales": "Curtidas totais",
  "Clicks": "Cliques",
  "País": "País",
  "Estado": "Status",
  "Acciones": "Ações",
  ...
  "Buscar": "Buscar",
  "Ver más": "Ver mais",
  "Rango temporal": "Intervalo de tempo",
  "Últimos 7 días de tu página pública.": "Últimos 7 dias da sua página pública.",
  "7 días": "7 dias",
  "90 días + países": "90 dias + países",
  "Nuevo perfil": "Novo perfil",
  "Nuevo perfil independiente": "Novo perfil independente",
  "Personaliza y actualiza tus páginas.": "Personalize e atualize suas páginas.",
  "Límite alcanzado": "Limite atingido",
  "Has alcanzado el límite de perfiles de tu plan.": "Você atingiu o limite de perfis do seu plano.",
  "Mejorar plan": "Melhorar plano",
  "Mejorar ahora": "Melhorar agora",
  "Tus QSY Coins": "Suas QSY Coins",
  "Tu saldo": "Seu saldo",
  "Conseguir más en Misiones": "Conseguir mais em Missões",
  "Gana QSY Coins completando misiones difíciles.": "Ganhe QSY Coins completando missões difíceis.",
  "Progreso": "Progresso",
  "Progreso del perfil": "Progresso do perfil",
  "Reclamar": "Resgatar",
  "Completada": "Concluída",
  "Completar": "Completar",
  "Desbloqueado": "Desbloqueado",
  "Catálogo": "Catálogo",
  "Historial de regalos": "Histórico de presentes",
  "Tu URL de perfil": "A URL do seu perfil",
  "Elige tu dominio QSY, copia tu URL o descarga un código QR.":
    "Escolha seu domínio QSY, copie sua URL ou baixe um QR code.",
  "Sin resultados.": "Sem resultados.",
  "Sin visitas aún": "Ainda sem visitas",
  "Nadie ha hecho clic todavía": "Ninguém clicou ainda",
  "Links más clickeados": "Links mais clicados",
  "Top países por visitas": "Principais países por visitas",
  "Aún no hay datos de visitas": "Ainda não há dados de visitas",
  "Aún no hay datos de países": "Ainda não há dados de países",
  "Aún no hay datos de dispositivos": "Ainda não há dados de dispositivos",
  "Aún no hay navegadores": "Ainda não há navegadores",
  "Aún no hay referrers": "Ainda não há referrers",
  ...
  "Público — Visible para todos": "Público — Visível para todos",
  "No listado — Solo con el link": "Não listado — Somente com o link",
  "Privado — Solo tú": "Privado — Somente você",
