...
export const BADGES: BadgeDef[] = [
  ...
  { key: "early", name: "Early Supporter", description: "Insignia OG para los primeros 50 usuarios registrados. (Desactivada: ya no se otorga automáticamente.)", img: "/badges/earlysupporter.svg", action: "Ver OG Tags", href: "/dashboard/profile/share" },
