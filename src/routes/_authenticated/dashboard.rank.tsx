...
const TIERS: Tier[] = [
  {
    ...
    perks: [
      ...
      { label: "Image Host (galería de imágenes)", on: false },
  ...
  },
  {
    ...
    perks: [
      ...
      { label: "Image Host: 200 imágenes de hasta 15MB + insignia", on: true },
  ...
  },
  {
    ...
    perks: [
      ...
      { label: "Image Host ampliado: 500 imágenes de hasta 25MB", on: true },
